...
var CoachCoacheeService = (function () {
    ...
    CoachCoacheeService.prototype.getRhs = function (isAdmin) {
        return this.apiService.get(AuthService.GET_HRS, null, isAdmin).map(function (res) {
            var resArray = res.json();
            var hrs = new Array();
    ...
    CoachCoacheeService.prototype.getRhForId = function (rhId, isAdmin) {
        ...
        var params = [rhId];
        return this.apiService.get(AuthService.GET_HR_FOR_ID, params, isAdmin).map(function (response) {
    ...
    CoachCoacheeService.prototype.getAllCoacheesForRh = function (rhId, isAdmin) {
        ...
        var params = [rhId];
        return this.apiService.get(AuthService.GET_COACHEES_FOR_HR, params, isAdmin).map(function (response) {
    ...
    CoachCoacheeService.prototype.getAllPotentialCoacheesForRh = function (rhId, isAdmin) {
        ...
        var params = [rhId];
        return this.apiService.get(AuthService.GET_POTENTIAL_COACHEES_FOR_HR, params, isAdmin).map(function (response) {
            var json = response.json();
    ...
    CoachCoacheeService.prototype.getUsageRate = function (rhId) {
        ...
        var param = [rhId];
        return this.apiService.get(AuthService.GET_USAGE_RATE_FOR_HR, param).map(function (response) {
            var json = response.json();
